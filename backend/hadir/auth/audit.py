...
from hadir.db import audit_log, super_admin_audit
...
# whose ``hadir_super_session`` cookie carries an
...
_super_admin_context: contextvars.ContextVar[Optional[dict[str, Any]]] = (
    contextvars.ContextVar("hadir_super_admin_audit_ctx", default=None)
)
