...
# Each constant maps to a ``MAUGOOD_RETENTION_*_DAYS`` env var so
...
def run_retention_sweep(
    ...
    *,
    ...
    cutoffs = {
        "camera_health": _days(
            "MAUGOOD_RETENTION_CAMERA_HEALTH_DAYS", CAMERA_HEALTH_DAYS_DEFAULT
        ),
        "notifications": _days(
            "MAUGOOD_RETENTION_NOTIFICATIONS_DAYS", NOTIFICATIONS_DAYS_DEFAULT
        ),
        "report_runs": _days(
            "MAUGOOD_RETENTION_REPORT_RUNS_DAYS", REPORT_RUNS_DAYS_DEFAULT
        ),
        "user_sessions": _days(
            "MAUGOOD_RETENTION_USER_SESSIONS_DAYS", USER_SESSIONS_DAYS_DEFAULT
        ),
    }
