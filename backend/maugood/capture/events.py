    ...
    * ``max_faces_per_event`` — stored on the camera row and
    ...
    if detector_config is not None:
        try:
            ...
            from maugood.detection.metadata import current_metadata  # noqa: PLC0415
    ...
    from maugood.metrics import observe_detection_event  # noqa: PLC0415
...
def write_health_snapshot(
    ...
    *,
    ...
    from maugood.metrics import set_camera_reachable  # noqa: PLC0415
