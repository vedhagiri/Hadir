...
from maugood.emailing.render import render_notification_email_html
from maugood.emailing.secrets import decrypt_secret
from maugood.notifications.categories import CATEGORY_LABELS
...
from maugood.reporting.pdf import HEX_PALETTE
...
def _build_message(
    *,
    ...
    if notification.link_url:
        text_lines.append("")
        text_lines.append(f"Open in Maugood: {notification.link_url}")
    return EmailMessage(
        subject=notification.subject,
        html=html,
        text="\n".join(text_lines),
