...
from maugood.entra_sync.router import router as entra_sync_router
...
from maugood.devices.ingest_router import router as device_ingest_router
...
def create_app() -> FastAPI:
    ...
    # Anonymous: attendance terminals post here with only their token.
